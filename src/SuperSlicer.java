...
/**
 * Implementation of the Super Slicer slicer type.
 */
public class SuperSlicer extends Slicer{
    ...
    /**
     * Constructor for new super slicer at start of the path
     ...
     */
    SuperSlicer(int SpawnID, ArrayList<Point> inRoute){
        nextpointnum = 1;
        spawnID = SpawnID;
        ...
        image = new Image("res/images/superslicer.png");
        health = startHealth;
        gone = false;
    }
    /**
     * Constructor for when a mega slicer was destroyed
     * @param SpawnID  is a unique identifier, given by WaveControl instance.
     * @param inRoute  is the route for this slicer to take, given by WaveControl instance.
     * @param xpos  is the x position where the mega slicer died
     * @param ypos  is the y position where the mega slicer died
     * @param nextpoint  is the number of the point the mega slicer was travelling to
     */
    SuperSlicer(int SpawnID, ArrayList<Point> inRoute, int nextpoint, double xpos, double ypos){
    ...
    private void destroyed() {
        ...
        ShadowDefend.waveControl.SuperSlicerDeath(nextpointnum, x, y);
        gone = true;
    }
