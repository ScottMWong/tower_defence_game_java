...
/**
 * Implementation of the Tank tower type.
 */
public class Tank extends Tower{
    ...
    //Gameplay values
    private static final int cooldownms = 1000;
     ...
     * @param point  The point at which the mouse was clicked to place the tank.
     */
    Tank (Point point) {
        image = new Image("res/images/tank.png");
    ...
    protected void towerUpdate(int timescale) {
        ...
        if (timeSinceShotms >= cooldownms) {
            ...
            if (targetID != -1) {
                timeSinceShotms = 0;
                ShadowDefend.waveControl.projectileList.add(new TankProjectile(targetID,x,y));
