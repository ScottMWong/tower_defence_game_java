...
/**
 * Implementation of the Mega Slicer slicer type.
 */
public class MegaSlicer extends Slicer{
    ...
    private static final int startHealth = 2;
    private static final double speedPxFrame = 1.5;
    private static final int penalty = 4;
    private boolean gone;
    /**
     * Constructor for new mega slicer at start of the path
     ...
     */
    MegaSlicer(int SpawnID, ArrayList<Point> inRoute){
        nextpointnum = 1;
        spawnID = SpawnID;
        ...
        image = new Image("res/images/megaslicer.png");
        health = startHealth;
        gone = false;
    }
    /**
     * Constructor for when a apex slicer was destroyed
     * @param SpawnID  is a unique identifier, given by WaveControl instance.
     * @param inRoute  is the route for this slicer to take, given by WaveControl instance.
     * @param xpos  is the x position where the apex slicer died
     * @param ypos  is the y position where the apex slicer died
     * @param nextpoint  is the number of the point the apex slicer was travelling to
     */
    MegaSlicer(int SpawnID, ArrayList<Point> inRoute, int nextpoint, double xpos, double ypos){
    ...
    private void destroyed() {
        ...
        ShadowDefend.waveControl.MegaSlicerDeath(nextpointnum, x, y);
        gone = true;
    }
